...
const Navbar = () => {
    ...
    return (
        <div className='sticky top-0 left-0 w-full h-14 z-50 flex justify-between items-center gap-3 max-md:bg-white max-md:shadow-md max-md:shadow-purple-600 rounded-full max-md:w-3/4  m-auto max-md:flex-col max-md:h-auto'>
