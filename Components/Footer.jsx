...
const Footer = () => {
    return (
        <div className='w-full mt-2 font-bold border-purple-700 h-auto p-1 relative bottom-0 left-0 grid grid-cols-3 gap-2  max-md:grid-cols-2  '>
            {/* sitemap section */}
            <div className='sitemap max-md:cols-span-1 flex h-40 shadow-md justify-center items-start flex-col max-md:items-center  '>
            ...
            {/* socialmedia section */}
            <div className='socialmedia max-md:col-span-1  flex h-40 shadow-md justify-center items-start flex-col max-md:items-center '>
            ...
            {/* services */}
            <div className='Services max-md:col-span-3 flex h-40 shadow-md justify-center items-start flex-col max-md:items-center '>
