...
const Footer = () => {
    return (
        <div className='w-full mt-2 border-t-2 border-purple-700  shadow-md shadow-purple-500   h-auto p-1 relative bottom-0 left-0 grid grid-cols-3 gap-2 place-items-center max-md:grid-cols-2 max-sm:flex justify-center items-center flex-col  '>
            ...
            {/* sitemap section */}
            <div className='sitemap w-56 max-md:cols-span-1 max-md:shadow-purple-500 flex h-40 shadow-md justify-center items-start flex-col max-md:items-center max-sm:w-full '>
            ...
            {/* socialmedia section */}
            <div className='socialmedia w-56 max-md:col-span-1 max-md:shadow-purple-500 flex h-40 shadow-md justify-center items-start flex-col max-md:items-center  max-sm:w-full'>
            ...
            {/* services */}
            <div className='Services max-md:shadow-purple-500 w-56 max-md:col-span-3 flex h-40 shadow-md justify-center items-start flex-col max-md:items-center  max-sm:w-full '>
